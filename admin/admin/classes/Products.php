...
class Products
{
	...
	public function getProducts(){
		$q = $this->con->query("SELECT p.pro_id, p.pro_name, p.image, p.price, p.description, c.cate_name, c.cate_id FROM products p JOIN categories c ON c.cate_id = p.cate_id");
